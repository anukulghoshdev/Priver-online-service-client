...
import research_action from '../../../assests/others/research_action.jpg'
        ...
        <section className="text-gray-600 body-font">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center" data-aos="fade-right">
                    ...
                    <h1 className="title-font mb-4 text-5xl font-bold text-black w-[80%] py-6">Your Research. Managed by an experts</h1>
                    <p className="mb-8 leading-relaxed text-lg text-black font-medium">When you do not have a team of research experts in-house, We will be here with our services is here to manage everything for you.</p>
                    <div className="flex w-full md:justify-start justify-center items-end">
                        ...
                        <button className="inline-flex text-white bg-gray-900 border-0 py-2 px-6 focus:outline-none hover:bg-slate-800 rounded text-lg">GET IN TOUCH</button>
                    </div>
